...
| Review-wide winbar label, progress and stopped-review rows | `tree_ui.lua`, `ui_icons_ui.lua`, `ui_labels.lua`, `panel_ui.lua`, `line_stats_ui.lua`, `navigation_edges.lua`; `probe.lua` with `interaction_probe.lua` |
