...
local ok, err = xpcall(function()
  ...
  assert(action("H") == "show_help" and action("g?") == "show_help")
  assert(action("X") == "Custom callback" and not action("q") and not action("R"))
  ...
  press("H")
  assert(action("H") == "show_help" and action("Y") == "Custom callback")
