...
local ok, err = xpcall(function()
  ...
  assert(not vim.wo[view.explorer_win].winbar:find("files", 1, true))
  assert(vim.wo[view.explorer_win].winbar:find("2 / 2", 1, true), "File position is missing")
  assert(vim.wo[view.right_win].winbar:find("Worktree", 1, true))
